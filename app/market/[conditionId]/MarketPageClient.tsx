    ...
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="bg-[var(--surface-container-lowest)] rounded-2xl p-8 shadow-ambient">
        ...
        <div className="flex gap-2">
          <button
            onClick={shareOnX}
            className="flex items-center gap-2 px-4 py-2.5 text-xs font-bold bg-[var(--surface-container-high)] text-white rounded-lg hover:opacity-90 transition-all cursor-pointer"
          >
